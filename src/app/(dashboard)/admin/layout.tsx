...
import { LogOut, Menu, X, Bell, Search, Shield } from "lucide-react"
    ...
    <div className="flex h-screen bg-muted/30 overflow-hidden">
      ...
      >
        <div className="p-6 border-b border-steel-800">
          <Link href="/admin/dashboard" className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-steel-400">BuildForce HQ</p>
            </div>
          </Link>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-steel-800">
          <button className="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-steel-300 hover:bg-steel-900 hover:text-white transition-colors text-sm">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 border-b border-border/50 bg-background flex items-center justify-between px-4 lg:px-8 sticky top-0 z-40">
          <button
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <div className="h-9 w-9 rounded-full bg-brand-500 flex items-center justify-center text-white font-semibold text-sm">
              A
            </div>
          </div>
        </header>
