...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="h-9 px-3 rounded-md hover:bg-muted transition-colors"
                    ...
                    <div className="flex flex-col gap-1">
                      {group.items.map((item) => {
                        ...
                        return (
                          ...
                          >
                            {Icon && (
                              <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-md bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-400">
          ...
          <div className="container py-4 space-y-1">
            ...
            <div className="pt-4 mt-4 border-t">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Link
                  href="/for-students"
                  className="flex items-center gap-2 p-3 rounded-lg border hover:border-brand-500 hover:bg-brand-50 dark:hover:bg-brand-500/10 transition-colors"
                >
